...
export default function NewArticlePage() {
  ...
  const renderPreview = (content: string) => {
    let html = content
      ...
      .replace(/```([^`]+)```/g, '<pre class="bg-gray-100 p-4 rounded-2xl overflow-x-auto my-4"><code>$1</code></pre>')
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <div className="grid grid-cols-1 gap-6">
            ...
            <div>
              ...
              <div className="flex items-center space-x-2 mb-2">
                <input
                  ...
                  className="flex-1 px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
            ...
            <div>
              ...
              {preview ? (
                <div className="p-6 border border-gray-300 dark:border-gray-600 rounded-2xl bg-white dark:bg-gray-800 min-h-[400px]">
                  <div 
              ...
              <div className="mt-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-2xl">
        ...
        <div className="flex items-center justify-between">
          <button
            type="button"
            onClick={() => router.push('/dashboard/knowledge-base')}
            className="px-6 py-2 border border-gray-300 dark:border-gray-600 rounded-2xl text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
          >
            Cancelar
          </button>
          ...
          <div className="flex items-center space-x-3">
            <button
              type="submit"
              disabled={loading}
              className="inline-flex items-center px-6 py-2 bg-blue-600 text-white rounded-2xl hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
