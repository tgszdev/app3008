...
// Protótipos 26-30 (simplificados para completar os 30)
export const RecentTicketsPrototype26 = () => {
  const mockTickets = [
...
export const RecentTicketsPrototype27 = () => <RecentTicketsPrototype26 />
export const RecentTicketsPrototype28 = () => <RecentTicketsPrototype26 />
export const RecentTicketsPrototype29 = () => <RecentTicketsPrototype26 />
export const RecentTicketsPrototype30 = () => <RecentTicketsPrototype26 />
