...
// Protótipo 41: Texto com Layout em Duas Colunas
...
// Protótipo 42: Texto com Indicador de Progresso
...
// Protótipo 43: Texto com Layout de Lista
...
// Protótipo 44: Texto com Layout de Card Expandido
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
      <div className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm relative overflow-hidden">
        ...
        <div className="relative">
          <div className="text-center">
            <div className="text-lg text-gray-600 dark:text-gray-400 mb-3">Total no Período</div>
      ...
      {mockData.status.map((status, index) => (
        <div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700 shadow-sm relative overflow-hidden">
          ...
          <div className="relative">
            <div className="text-center">
              <div className="text-lg text-gray-600 dark:text-gray-400 mb-3">{status.name}</div>
...
// Protótipo 45: Texto com Layout de Tabela
...
// Protótipo 46: Texto com Layout de Dashboard
...
// Protótipo 47: Texto com Layout de Card Minimalista
...
// Protótipo 48: Texto com Layout de Card com Destaque
...
// Protótipo 49: Texto com Layout de Card com Informações Extras
...
// Protótipo 50: Texto com Layout de Card com Estatísticas
