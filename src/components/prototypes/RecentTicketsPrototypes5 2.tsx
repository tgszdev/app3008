...
// Protótipos 21-25 (simplificados para completar os 30)
export const RecentTicketsPrototype21 = () => {
  const mockTickets = [
...
export const RecentTicketsPrototype22 = () => <RecentTicketsPrototype21 />
export const RecentTicketsPrototype23 = () => <RecentTicketsPrototype21 />
export const RecentTicketsPrototype24 = () => <RecentTicketsPrototype21 />
export const RecentTicketsPrototype25 = () => <RecentTicketsPrototype21 />
