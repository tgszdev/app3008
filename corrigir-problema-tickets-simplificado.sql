-- =====================================================
-- CORREÇÃO SIMPLIFICADA DO PROBLEMA: operator does not exist: integer ~~ text
...
-- 4. VERIFICAR SEQUÊNCIA DO TICKET_NUMBER (VERSÃO SIMPLIFICADA)
-- =====================================================
SELECT 
    schemaname,
    sequencename,
...
-- =====================================================
-- FIM DO SCRIPT DE DIAGNÓSTICO SIMPLIFICADO
-- =====================================================
-- 
