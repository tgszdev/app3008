-- Script seguro para criar/atualizar tabela roles
...
-- Criar índice para busca rápida por nome (se não existir)
CREATE INDEX IF NOT EXISTS idx_roles_name ON public.roles(name);

-- Habilitar RLS (Row Level Security) - não gera erro se já estiver habilitado
...
-- Criar política para permitir insert/update/delete apenas para admins
...
DO $$
BEGIN
  RAISE NOTICE 'Tabela roles configurada com sucesso!';
END $$;