-- =====================================================
-- CONFIGURAÇÃO PG_CRON PARA ESCALAÇÃO AUTOMÁTICA
-- =====================================================
...
-- 3. Função para executar escalação automática
...
-- 4. Função para executar escalação de um ticket específico
...
-- 5. Função para verificar se escalação deve ser executada
...
-- 6. Função para executar ações de escalação
...
-- 7. Função para processar e-mails de escalação
...
-- 8. Configurar job pg_cron para executar a cada 5 minutos
-- IMPORTANTE: Execute este comando separadamente após criar as funções

-- SELECT cron.schedule(
--     'auto-escalation',
--     '*/5 * * * *', -- A cada 5 minutos
--     'SELECT execute_auto_escalation();'
-- );

-- 9. Configurar job pg_cron para processar e-mails a cada 2 minutos
-- SELECT cron.schedule(
--     'process-escalation-emails',
--     '*/2 * * * *', -- A cada 2 minutos
--     'SELECT process_escalation_emails();'
-- );

-- 10. Verificar jobs configurados
-- SELECT * FROM cron.job;

-- 11. Verificar execuções dos jobs
-- SELECT * FROM cron.job_run_details ORDER BY start_time DESC LIMIT 10;

-- 12. Para remover jobs (se necessário)
