-- ====================================================================
-- TESTE RÁPIDO DO SISTEMA DE SESSÃO ÚNICA
-- Execute este script no Supabase SQL Editor para testar o trigger
-- ====================================================================
...
BEGIN
    ...
    FOR session1_id IN 
        SELECT id FROM public.sessions WHERE "userId" = test_user_id ORDER BY "createdAt"
    LOOP
