...
-- 10. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO UPDATED_BY
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 11. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO ASSIGNED_TO_MATRIX_USER
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 12. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO REQUESTER_CONTEXT_USER_ID
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 13. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO PRIORITY
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 14. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO STATUS
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 15. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO CATEGORY
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 16. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO IS_INTERNAL
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 17. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO DUE_DATE
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 18. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO RESOLUTION_NOTES
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 19. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO RESOLVED_AT
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 20. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO CLOSED_AT
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 21. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO UPDATED_BY
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 22. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO FIRST_RESPONSE_AT
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 23. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO SATISFACTION_RATING
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- 24. VERIFICAR SE HÁ ALGUM PROBLEMA COM O CAMPO RATED_AT
-- =====================================================
SELECT 
    column_name,
    data_type,
...
-- =====================================================
-- FIM DO SCRIPT DE DIAGNÓSTICO DEFINITIVO
-- =====================================================
-- 
